...
func handleMethod(ctx context.Context, method string, request []byte) ([]byte, error) {
	...
	case pluginabi.MethodSchedulerPick:
		...
		return okEnvelope(pickAntigravityAuth(ctx, req))
	default:
			...
			ConfigFields: []pluginapi.ConfigField{
				{
					...
					Description: "Write antigravity priority scheduler diagnostics to the host log.",
				},
				{
					Name:        "strategy",
					Type:        pluginapi.ConfigFieldTypeEnum,
					EnumValues:  []string{strategyFillFirst, strategyRoundRobin},
					Description: "Selection strategy inside the highest priority_claude/priority_gemini bucket.",
				},
			},
		},
		Capabilities: registrationCapabilities{Scheduler: true},
	}
}
