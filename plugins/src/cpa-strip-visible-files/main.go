			...
			ConfigFields: []pluginapi.ConfigField{
				{
					...
					Description: "Write strip diagnostics to the host log.",
				},
				{
					Name:        "logs-dir",
					Type:        pluginapi.ConfigFieldTypeString,
					Description: "Directory for strip detail logs. Relative paths resolve from the CPA working directory. Default: logs",
				},
				{
				...
				},
				{
					Name:        "detail-log",
					Type:        pluginapi.ConfigFieldTypeString,
					Description: "Write before/after strip detail files. auto=only when host request-log=true and commercial-mode=false. Values: auto|true|false",
				},
			},
		},
