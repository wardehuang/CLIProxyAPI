...
type rpcRequestMetadataEnrichRequest struct {
	pluginapi.RequestMetadataEnrichRequest
	HostCallbackID string `json:"host_callback_id,omitempty"`
}

type rpcRouteRewriteRequest struct {
...
type rpcStreamCompletionInterceptRequest struct {
...
func rpcCapabilitiesFromPlugin(plugin pluginapi.Plugin) rpcCapabilities {
	...
	return rpcCapabilities{
		...
		StreamCompletionInterceptor:   caps.StreamCompletionInterceptor != nil,
